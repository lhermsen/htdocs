...
// Maximaal aantal leden dat geexporteerd mag worden door een reunistenbeheerder
$config['iReunist_export_max'] = 50;

// Maximaal aantal reunisten dat geexporteerd mag worden door een ledenbeheerder
$config['iLid_export_max'] = 50;
